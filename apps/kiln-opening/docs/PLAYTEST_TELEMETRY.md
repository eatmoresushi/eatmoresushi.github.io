...
Current **V1.2.7** telemetry records Crown-driven Imperial Recognition 0–4, every milestone and overflow-Crown VP, the six-card Main Order queue's two-card round-start rotation, unlimited End-game Exhibition and whole-collection diversity scoring, Fire and Quality distributions, Jun/Ge, the Work-Phase Kiln Yard Shifu target and its after-Base/before-Fire +1/−1 Heat-marker choice or decline, public Contribution cards and effective Heat only after simultaneous reveal, Fuel Ledger upgrades, Starting and Advanced Tech effects, per-reservation advances, all eight shared action locations including Court Patronage, Labour, the 2-Coin Flawed salvage, Imperial Kiln loads and before/after-worker-action Imperial Priority use. The fixed Shifu Heat adjustment is recorded independently of zone, Base Heat and Global Heat and remains applicable through Second Firing. Held Orders, Colour Samples choices, Test Pieces peeks and unrevealed Fuel Ledger commitments remain private. Obsolete private workshop spaces, Tech-based space unlocks, Imperial Seal, Apprentice-unlock and Progress-stipend events are not produced by V1.2.7. Historical exports remain immutable under their original rules labels.
