...
/**
 * Order card art, once V1.2.5 fronts exist.
 *
 * The V0.4 sheets this read were the obsolete 20-Market / 10-Imperial split, keyed by `M`
 * and `I` ids. V1.2.5 ships 16 Starting + 48 unified Main Orders as `S`/`O`, so neither
...
/**
 * Board labels come from the V1.2.5 action-location data, never a hand-copied list.
 * The ids are stable legacy keys: `market_imperial_office` is V1.2.5's Commission
