...
describe("tabletop compact Technique copy", () => {
  ...
  it("preserves the supplied compact English and Simplified Chinese wording", () => {
    expect(TECHNIQUE_SHORT_COPY).toEqual({
      ...
      T04: { en: "Once/round, after **Potter’s Wheel**: give 1 vessel formed by that action **any Glaze + any Decoration**; pay its Decoration cost.", "zh-CN": "每轮一次，**陶车坊**行动后：将本次行动形成的 1 件器物施以**任意釉色 + 任意纹饰**；支付该纹饰费用。" },
      ...
      T07: { en: "Once/round: one **Carved** Decoration you apply costs **0 Coins**.", "zh-CN": "每轮一次：你施加的 1 个**刻花**纹饰费用为 **0 铜钱**。" },
      T08: { en: "Once/round: one **Impressed** Decoration you apply costs **0 Coins**.", "zh-CN": "每轮一次：你施加的 1 个**印花**纹饰费用为 **0 铜钱**。" },
      T09: { en: "Once/round: one **Crackle** Decoration you apply costs **0 Coins**.", "zh-CN": "每轮一次：你施加的 1 个**开片**纹饰费用为 **0 铜钱**。" },
