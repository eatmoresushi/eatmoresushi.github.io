...
describe("v1.1.4 authoritative content", () => {
  it("loads v1.1.4 content versions, deck sizes and Glaze heats", () => {
    expect(GAME_CONFIG.rulesVersion).toBe("1.1.4");
    expect(IMPERIAL_PROGRESS.rulesVersion).toBe("1.1.4");
  ...
  it("carries the v1.1.4 Order values", () => {
  ...
  it("prices the v1.1.4 Techniques as printed", () => {
    ...
    // Firing Techniques activate with Wood in v1.1.4, never Coins.
